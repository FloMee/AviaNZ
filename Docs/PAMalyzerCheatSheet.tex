  ...
  \begin{frame}[fragile]{} 
    ...
    \begin{columns}[t]
      \begin{column}{.28\linewidth}
        \maketitle
	\textbf{PAMalyzer} helps you to classify your recordings with BirdNET.
	...
	A usual workflow with BirdNET in PAMalyzer would consist of the following steps:
...
\end{subblock}
	\begin{subblock}{Review Results of Classification}
		...
		\begin{tabular}[]{m{3.2em}m{18em}}
			\includegraphics[height=5.5em]{Figures/IconOverview.png} & 
...
\textbf{Select custom species list} & A ``white list'' that includes the species of interest; Must be a subset of the original species-lists of BirdNET-Lite or BirdNET-Analyzer respectively and in the selected language; Find these files in the installation directory of PAMalyzer under labels.\\ 
